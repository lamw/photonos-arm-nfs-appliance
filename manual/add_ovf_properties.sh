...
if [ "$(uname)" == "Darwin" ]; then
    ...
    sed -i .bak2 "/    <\/VirtualHardwareSection>/ r photon.xml" ${OVF_PATH}/${PHOTON_APPLIANCE_NAME}.ovf
    ...
    sed -i "/    <\/VirtualHardwareSection>/ r photon.xml" ${OVF_PATH}/${PHOTON_APPLIANCE_NAME}.ovf
